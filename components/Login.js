          ...
          {Object.values(providers).map((provider) => (
            <div key={provider.name}>
              <a
                ...
                href="#_"
                class="relative inline-flex mb-4 items-center justify-start inline-block px-5 py-3 overflow-hidden font-medium transition-all bg-blue-600 rounded-full hover:bg-white group"
              >
